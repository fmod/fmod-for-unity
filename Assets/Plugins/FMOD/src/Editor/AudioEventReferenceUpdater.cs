...
namespace FMODUnity
{
    public class AudioEventReferenceUpdater : EditorWindow
    {
        ...
        private static IEnumerable<Task> GetUpdateTasks(UnityEngine.Object target)
        {
            ...
            else if (target is StudioAudioEventEmitter)
            {
                return GetEmitterUpdateTasks(target as StudioAudioEventEmitter);
            }
        ...
        private static IEnumerable<Task> GetEmitterUpdateTasks(StudioAudioEventEmitter emitter)
        {
            ...
            {
                StudioAudioEventEmitter sourceEmitter = PrefabUtility.GetCorrespondingObjectFromSource(emitter);
...
#pragma warning disable 0618
            public static Task ClearEvent(StudioAudioEventEmitter emitter)
            {
                return new Task()
                {
            ...
            public static Task MoveEventToEventReference(StudioAudioEventEmitter emitter)
            {
                return new Task()
                {
            ...
            public static Task MoveEventOverrideToEventReference(StudioAudioEventEmitter emitter)
            {
                return new Task()
                {
